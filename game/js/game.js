    ...
    setupInput() {
        ...
        this.canvas.addEventListener('touchend', (e) => {
            ...
            if (touchDuration < 500 && distance < 10) {
                this.handleClick(touchEndX, touchEndY);
            }
            // Long press or drag could trigger context menu
            else if (touchDuration >= 500 && distance < 20) {
                this.handleRightClick(touchEndX, touchEndY);
            }
        }, { passive: false });
